...
COPY --from=dclong/rust-utils:rust_nightly /usr/local/rustup/ /usr/local/rustup/
COPY --from=dclong/rust-utils:rust_nightly /usr/local/cargo/bin /usr/local/cargo/bin
COPY --from=dclong/rust-utils:rust_nightly /root/.local/share/jupyter/kernels/rust/ /usr/local/share/jupyter/kernels/rust/
